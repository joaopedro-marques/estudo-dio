...
public class MadLibs {
  ...
  public void enterNoun3(){
    System.out.println("Give me athe last noun: ");
  ...
  public void putTogetherTheStory(){
    ...
    if (num ==0 ){
      ...
      + " they decided to climb " + getAdverb() + " into the " + getNoun3() + " to get a close look."
      + " The zoo was" + getAdjective1() + " at night, bute they didn't care... "
      + " until " + getRandomNums() + " " + getAdjective2() + " apes yelled in ther faces, making "
